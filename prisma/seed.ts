...
const permissions = [
  ...
  { name: "discount:create", description: "Create discounts" },
  { name: "discount:read", description: "View discounts" },
  { name: "discount:update", description: "Update discounts" },
  { name: "discount:delete", description: "Delete discounts" },
  { name: "voucher:create", description: "Create vouchers" },
  { name: "voucher:read", description: "View vouchers" },
  { name: "voucher:update", description: "Update vouchers" },
