...
import adminPromoReportRoutes from "./modules/admin-promo-report/adminPromoReport.routes.js";
import adminSalesReportRoutes from "./modules/admin-sales-report/adminSalesReport.routes.js";
...
app.use("/api/admin/sales-reports", adminSalesReportRoutes);
